...
function addCategory(event) {
    ...
    if (name.length > 0) {
        ...
        fetch('https://oliviercharlet.sites.3wa.io/php/Projet-Distorsion-iman-kelly-olivier-jl/bre01-distorsion-main/index.php?route=create-category', options)
...
function addChannel(event)
{
    ...
    if(name.length > 0)
    {
        ...
        fetch('https://oliviercharlet.sites.3wa.io/php/Projet-Distorsion-iman-kelly-olivier-jl/bre01-distorsion-main/index.php?route=create-channel', options)
            .then(response => response.json())
            .then(data => {
                console.log(data);
...
function switchChannel(event)
{
    ...
    fetch('https://oliviercharlet.sites.3wa.io/php/Projet-Distorsion-iman-kelly-olivier-jl/bre01-distorsion-main/index.php?route=chat&channel=' + chanId)
        .then(response => response.json())
        .then(data => {
            console.log(data);
